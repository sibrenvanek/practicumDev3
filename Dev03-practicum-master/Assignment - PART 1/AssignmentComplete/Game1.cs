...
namespace AssignmentComplete
{
  ...
  public class Game1 : Game
  {
    ...
    protected override void Initialize()// deze methode heeft voorrang op de Initialize() van Game. 
    {
      base.Initialize();
    }

    
    GameState gameState; //plaatje loaden class
    ...
    protected override void Update(GameTime gameTime) //besturing game
    {
    ...
    protected override void Draw(GameTime gameTime) //drawed the graphics.
    {
